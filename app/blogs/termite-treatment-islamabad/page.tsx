    ...
    <>
      ...
      <FadeIn>
        <article>
          ...
          </div><aside className="h-fit rounded-2xl border border-slate-200 bg-slate-50 p-6 lg:sticky lg:top-28"><p className="text-sm font-semibold uppercase tracking-[0.18em] text-brand-green">In this article</p><ul className="mt-4 list-disc space-y-3 pl-5 text-sm leading-6 marker:text-brand-green text-slate-600"><li>Why termites are a problem?</li><li>Signs to look for.</li><li>How treatment works?</li><li>Prevention tips</li><li>Frequently asked questions?</li></ul></aside></div></section>
        </article>
      </FadeIn>
