...
const itemDescriptions: Record<string, string> = {
  ...
  "disinfection services":
    "High-touch disinfection coverage for workstations, waiting zones, shared surfaces, counters, and occupied common areas.",
  "floor cleaning polishing":
    "Cleaning and polishing support that improves shine, removes buildup, and restores presentation across hard-surface floors.",
  "floor scoring":
    "Floor scoring service to prepare worn surfaces before deeper cleaning, resurfacing, or polish recovery work.",
  "water tank cleaning":
    "Water tank cleaning for sediment reduction, hygiene improvement, and planned maintenance of storage systems.",
};
...
const categoryContent: Record<string, ServiceCategoryContent> = {
  ...
  "maintenance/disinfection": {
    heroTitle: "Best Disinfection Services in Islamabad/Rawalpindi",
    heroDescription:
      "Professional disinfection services designed for cleaner touchpoints, work areas, and shared environments with a focus on practical hygiene support.",
    overviewTitle: "Disinfection support for healthier everyday environments",
    overviewParagraphs: [
      "Disinfection is most effective when it is aligned with how a property is used. Our service focuses on high-touch surfaces, shared-use areas, staff spaces, and visitor zones so clients can maintain a cleaner environment with more confidence.",
      "We work with offices, schools, clinics, retail spaces, and residential properties that need dependable sanitization support for regular upkeep, special events, or post-incident cleaning requirements.",
      "Visitors looking for office disinfection, clinic sanitization, school disinfection, or routine shared-space hygiene support can now see the service coverage more clearly on this page.",
    ],
    metrics: [
      { value: "High-touch", label: "Area priority" },
      { value: "Shared-space", label: "Typical environment" },
      { value: "Routine + urgent", label: "Use cases" },
    ],
    highlights: [
      "Disinfection planning for shared spaces and frequent-contact surfaces",
      "Suitable for commercial, institutional, and residential environments",
      "Useful for scheduled hygiene support or one-time service needs",
      "Clear service scope for touchpoints, rooms, and common areas",
    ],
    suitableFor: [
      "Offices and coworking spaces with shared desks and meeting rooms",
      "Schools and training centers with daily student movement",
      "Clinics, waiting areas, and service counters",
      "Retail locations and homes needing targeted sanitization support",
    ],
    warningSigns: [
      "High-touch surfaces are used constantly with limited hygiene control between shifts",
      "Shared spaces need stronger routine sanitization for staff and visitor comfort",
      "A property needs a more organized cleaning plan after heavy usage or special events",
    ],
    faqs: [
      {
        question: "What areas are usually prioritized during disinfection service?",
        answer:
          "Common priority areas include door handles, counters, workstations, waiting zones, washrooms, hand-contact surfaces, and high-use shared spaces.",
      },
      {
        question: "Can disinfection services be used for both commercial and residential properties?",
        answer:
          "Yes. The scope can be tailored to office layouts, institutional environments, clinics, shops, or shared-use residential settings.",
      },
      {
        question: "Is disinfection only for emergencies?",
        answer:
          "No. Many clients use it as part of routine hygiene maintenance to keep common areas cleaner and more manageable.",
      },
    ],
    process: [
      {
        ...
        description:
          "We identify high-contact points, shared-use areas, and surfaces that need priority disinfection coverage.",
      },
      {
        title: "Structured sanitization",
        description:
          "Our team delivers the disinfection service in a clear sequence to cover practical touchpoints and occupied zones.",
      },
      {
        title: "Routine care recommendations",
        description:
          "We share useful maintenance guidance to help keep the space cleaner between professional visits.",
      },
    ],
    image: "/Disinfection.png",
    imageAlt: "Professional disinfection service in Islamabad/Rawalpindi - office or shared indoor environment",
  },
  "maintenance/floor": {
    heroTitle: "Floor Cleaning and Polishing Services for Residential and Commercial Interiors",
    heroDescription:
      "Restore the look of tiled, stone, and hard-surface floors with floor cleaning, scoring, and polishing services for homes, offices, lobbies, and retail interiors.",
    overviewTitle: "Bring back floor shine, cleanliness, and presentation value",
    overviewParagraphs: [
      "Floors affect the first impression of any property. Our floor cleaning and polishing service helps remove dullness, buildup, and daily wear so interior spaces look cleaner, brighter, and better maintained.",
      "We support both residential and commercial clients with floor care plans that reflect the surface type, traffic level, and appearance goals of the property.",
      "For clients searching for floor polishing, deep floor cleaning, or floor scoring before restoration, this category now shows the main options as image cards instead of plain text only.",
    ],
    metrics: [
      { value: "2+", label: "Floor care options" },
      { value: "Visual uplift", label: "Main outcome" },
      { value: "Homes + lobbies", label: "Typical spaces" },
    ],
    highlights: [
      "Cleaning and polishing support for residential and commercial floors",
      "Useful for lobbies, corridors, showrooms, offices, and living areas",
      "Surface care designed to improve finish and presentation",
      "Available for routine maintenance or appearance-focused cleanup",
    ],
    suitableFor: [
      "Office interiors with dull, high-traffic flooring",
      "Retail or showroom environments needing a polished finish",
      "Homes preparing for guests, tenants, or routine maintenance",
      "Buildings requiring floor scoring before deeper care work",
    ],
    warningSigns: [
      "Floors look dull even after regular mopping or housekeeping",
      "Traffic lanes, stains, or uneven finish reduce interior presentation",
      "A surface needs scoring before polish recovery or deeper restoration work",
    ],
    faqs: [
      {
        question: "What is floor scoring used for?",
        answer:
          "Floor scoring helps prepare worn or uneven surfaces before deeper care, especially where buildup or finish loss affects the final appearance.",
      },
      {
        question: "Is this service only for commercial interiors?",
        answer:
          "No. Floor cleaning and polishing can be planned for homes, apartments, offices, lobbies, showrooms, and mixed-use interiors.",
      },
      {
        question: "Can polishing and cleaning be combined in one service plan?",
        answer:
          "Yes. Many clients use a combined plan so the surface is cleaned properly before the finish is improved.",
      },
    ],
    process: [
      {
        ...
        description:
          "We check the floor material, finish condition, and the type of buildup or wear affecting the surface.",
      },
      {
        title: "Cleaning and restoration",
        description:
          "Our team cleans, scores where needed, and polishes the floor according to the surface condition and finish goal.",
      },
      {
        title: "Maintenance advice",
        description:
          "We guide clients on practical upkeep steps to help preserve the cleaned and polished look for longer.",
      },
    ],
    image: "/floor.png",
    imageAlt: "Floor cleaning and polishing service on a smooth indoor surface",
  },
  "maintenance/water-tank": {
    heroTitle: "Water Tank Cleaning Services for Homes, Apartments, and Commercial Properties",
    heroDescription:
      "Keep stored water systems cleaner with structured water tank cleaning services for residential and commercial properties that need routine hygiene maintenance.",
    overviewTitle: "Water tank cleaning that supports safer storage conditions",
    overviewParagraphs: [
      "Water tanks can collect sediment, residue, and unwanted buildup over time, especially when routine cleaning is delayed. Our water tank cleaning service is designed to help clients improve system hygiene and keep water storage areas better maintained.",
      "We work with residential buildings, apartments, offices, and commercial properties that need dependable tank cleaning as part of regular property care.",
      "The updated layout also makes this service easier to scan for users looking specifically for overhead tank cleaning, underground tank maintenance, or scheduled hygiene support.",
    ],
    metrics: [
      { value: "Routine", label: "Maintenance-friendly" },
      { value: "Overhead + underground", label: "Tank coverage" },
      { value: "Residential + commercial", label: "Property fit" },
    ],
    highlights: [
      "Suitable for overhead, underground, residential, and commercial tanks",
      "Supports better water storage hygiene and routine maintenance",
      "Useful for apartments, homes, offices, and mixed-use buildings",
      "Service planning based on tank access and cleaning requirements",
    ],
    suitableFor: [
      "Homes and apartment buildings with scheduled tank maintenance needs",
      "Commercial properties managing daily water storage use",
      "Facilities preparing for occupancy, inspections, or seasonal cleaning",
      "Properties with visible sediment, odor, or overdue tank cleaning",
    ],
    warningSigns: [
      "Stored water systems show odor, residue, or visible sediment",
      "A tank has gone too long without scheduled cleaning and inspection",
      "Residential or commercial occupancy depends on cleaner water storage conditions",
    ],
    faqs: [
      {
        question: "Does this service cover both residential and commercial tanks?",
        answer:
          "Yes. The service can be planned for homes, apartment buildings, offices, and other commercial properties using stored-water systems.",
      },
      {
        question: "When should a tank be cleaned?",
        answer:
          "Tank cleaning is most useful when maintenance has been delayed, sediment or odor appears, or the property needs better routine hygiene control.",
      },
      {
        question: "Can this page help visitors compare tank-cleaning service fit quickly?",
        answer:
          "Yes. The updated gallery and content blocks make it easier to understand what the service covers and when it is usually needed.",
      },
    ],
    process: [
      {
        title: "Tank condition review",
        description:
          "We inspect the tank condition, access requirements, and visible buildup before planning the service.",
      },
      {
        title: "Cleaning and hygiene service",
        description:
          "Our team completes the cleaning process in a structured sequence to improve storage cleanliness.",
      },
      {
        title: "Maintenance scheduling guidance",
        description:
          "We advise on practical cleaning frequency and system care based on the type of property and usage pattern.",
      },
    ],
    image: "/tank2.png",
    imageAlt: "Water tank cleaning service for a residential or commercial property",
  },
};
...
function getItemMedia(itemLabel: string, fallbackImage: string, fallbackAlt: string) {
  ...
  if (label.includes("disinfection")) {
    return {
      image: "/Disinfection.png",
      imageAlt: "Disinfection service image",
    };
  }

  if (label.includes("floor scoring")) {
    return {
      image: "/floor.png",
      imageAlt: "Floor scoring service image",
    };
  }
  ...
  if (label.includes("floor")) {
    return {
      image: "/floor.png",
      imageAlt: "Floor cleaning and polishing service image",
    };
  }

  if (label.includes("water tank")) {
    return {
      image: "/tank2.png",
      imageAlt: "Water tank cleaning service image",
    };
  }
