...
const ceo = {
  ...
  bio: "Founded Islamabad PestControl in 2005 after 4 years with the NPMA. Muhummad Abuzar's vision has always been to make professional pest control accessible, safe, and dependable for every family and business we serve.",
};
      ...
      >
        ...
        <div className="container-max relative z-10 text-center">
          ...
          <h1 className="font-display text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            About <span className="text-green-200">Islamabad PestControl</span>
          </h1>
          <p className="text-sm sm:text-base lg:text-xl text-white/90 max-w-2xl mx-auto px-2">
            Islamabad PestControl is the most trusted pest control company, protecting homes and businesses since 2005.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>
                  At Islamabad PestControl, we focus on delivering high-quality pest management solutions that are safe for your family, property, and the environment. Our team uses advanced tools and industry-approved chemicals to eliminate pests efficiently and prevent future infestations.
                </p>
                <p>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <div className="space-y-4 text-sm leading-8 text-white/85 sm:text-base">
                ...
                <p>
                  Today, Islamabad PestControl employs over 50 certified specialists, serves 12+ service areas, and has protected more than 
      ...
      <section className="section-padding bg-gray-50 dark:bg-gray-900">
        <div className="container-max">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="section-heading mb-4">
              Policy of <span className="text-gradient">Islamabad PestControl Enterprises</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Islamabad PestControl, our policies reflect our dedication to quality service, environmental responsibility, and customer well-being.
            </p>
          </div>
