...
export default function TermiteControlPage() {
  const termiteControlService = mainServices.find(s => s.id === "termite-control")!;
    ...
    <>
      ...
      <section
       className="pt-32 sm:pt-40 lg:pt-48 pb-16 sm:pb-20 lg:pb-24 relative overflow-hidden bg-cover bg-center bg-no-repeat"
        style={{backgroundImage: 'linear-gradient(135deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.5) 100%), url(/images/optimized/termite1.webp)'}}
      >
        <div
      ...
      <section className="section-padding bg-white dark:bg-gray-950">
        <div className="container-max">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="font-display text-4xl font-semibold mb-4">Our Termite Control Services</h2>
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Browse our specialized termite treatment and prevention services below
            </p>
          </div>

          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {termiteControlService.categories.map((category) => (
              <div
                key={category.label}
