        ...
        <div className="container-max relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-white">
              IC Pest Control – your trusted partner for reliable pest control services in Islamabad and Rawalpindi. From termite inspection and fumigation to cockroach, rodent, and dengue control, we deliver complete solutions tailored for residential and commercial properties. Our experienced team ensures fast, safe, and long-lasting results you can depend on.
            </p>
          </div>
        </div>
      </section>
